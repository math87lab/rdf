# インポート
import pandas as pd
from to_rdf import AED,CareService,MedicalCare
#CulturalProperty, Tourism, Event, PublicWirelessLan, PublicToilet, FireHydrant, EvacuationSpace, Population, PublicFacility, Preshool
