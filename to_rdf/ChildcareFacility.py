...
def to_rdf(w, df):
    for i in range(len(df)):
        ...
        if access:
            w.write(subject + ' <http://imi.go.jp/ns/core/2#記述[1]> ' + '_:空白ノード10 .\n'
                    + '_:空白ノード10' + ' <http://imi.go.jp/ns/core/2#種別> ' + '"アクセス方法" .\n'
                    + '_:空白ノード10' + ' <http://imi.go.jp/ns/core/2#説明> ' + f'"{access}" .\n')

        if parking:
            w.write(subject + ' <http://imi.go.jp/ns/core/2#駐車場> ' + '_:空白ノード11 .\n'
                    + '_:空白ノード11' + ' <http://imi.go.jp/ns/core/2#説明> ' + f'"{parking}" .\n')
        ...
        if phone_number or extention_number or fax_number or corporate_number or group_name:
            ...
            if extention_number:
                w.write('_:空白ノード12' + ' <http://imi.go.jp/ns/core/2#内線番号> ' + f'"{extention_number}" .\n')
            if fax_number:
            ...
            if group_name:
                w.write('_:空白ノード12' + ' <http://imi.go.jp/ns/core/2#組織> ' + '_:空白ノード14 .\n'
                        + '_:空白ノード14' + ' <http://imi.go.jp/ns/core/2#名称> ' + '_:空白ノード15 .\n'
                        + '_:空白ノード15' + ' <http://imi.go.jp/ns/core/2#表記> ' + f'"{group_name}" .\n')
